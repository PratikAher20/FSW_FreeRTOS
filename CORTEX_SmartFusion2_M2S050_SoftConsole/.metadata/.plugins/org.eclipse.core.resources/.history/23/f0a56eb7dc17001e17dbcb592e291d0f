...
C_SRCS += \
../Tracelyzer/extras/RunnableExample/source/main.c 

OBJS += \
./Tracelyzer/extras/RunnableExample/source/main.o 

C_DEPS += \
./Tracelyzer/extras/RunnableExample/source/main.d 


# Each subdirectory must supply rules for building sources it contributes
Tracelyzer/extras/RunnableExample/source/%.o: ../Tracelyzer/extras/RunnableExample/source/%.c
	@echo 'Building file: $<'
